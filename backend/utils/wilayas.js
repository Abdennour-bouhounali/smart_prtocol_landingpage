module.exports = [
  { id: 1, name: 'Adrar - أدرار' },
  { id: 2, name: 'Chlef - الشلف' },
  { id: 3, name: 'Laghouat - الأغواط' },
  { id: 4, name: 'Oum El Bouaghi - أم البواقي' },
  { id: 5, name: 'Batna - باتنة' },
  { id: 6, name: 'Béjaïa - بجاية' },
  { id: 7, name: 'Biskra - بسكرة' },
  { id: 8, name: 'Béchar - بشار' },
  { id: 9, name: 'Blida - البليدة' },
  ...
  { id: 34, name: 'Bordj Bou Arreridj - برج بوعريريج' },
