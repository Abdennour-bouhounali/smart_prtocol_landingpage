      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-20)', alignItems: 'center' }}>
          ...
          >
            ...
            <Link to="/book" className="btn btn--primary btn--large" style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', padding: '20px 40px', fontSize: '1.125rem', borderRadius: '99px', fontWeight: 700 }}>
              تصفح محتويات الكتاب
              <ArrowLeft size={20} />
            </Link>
          </motion.div>
